...
#global variables
VERBOSE_LEVEL = 1 #set this to a higher value to see more verbose info in DynamiQ.log
                  #current max level is 4

#This list is used to set colors for different tasks/partitions on the call graph
colors = ["red", "green", "blue", "orange", "purple", "black", "brown", "cyan", "magenta", "yellow", "gray", "pink", "olive", "lime", "teal"]
COLOR_COUNT = len(colors)

spare_functions_set = set() #set of all functions that are not attached to the current callgraph 
profiled_seeds = set() #set of all seed inputs that have been used
                    #for profiling