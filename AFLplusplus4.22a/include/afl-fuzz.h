...
#include "uthash.h"  // Include uthash for hash set support
...
// Define the structure for the hash set
typedef struct hash_entry {
    char hash_value[64];  // hash value
...
u8 *get_test_case_hash(const char *file_path);
...
#define FOREIGN_SYNCS_MAX 32U
  ...
  // New field: hash set for processed test cases
  hash_set_t *processed_hashes;
